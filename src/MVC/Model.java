...
public class Model {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 1000; i++) {
			...
			if(input.equals("up")||input.equals("down")||input.equals("left")||input.equals("right")) {
				//move character 
				if(m.checkMove(input)) {m.player.updatePlayerLocation(input);}
	...
	Model(){
		...
		//arbitrary values to test whether stuff prints correctly
				GroundPatch grp1 = new GroundPatch(10,12);
				groundList.add(grp1);
				
				
				Obstacle ob1 = new Obstacle(10,9);
				obstacleList.add(ob1);
				
				InvasivePlant inv1 = new InvasivePlant(10, 10);
				InvasivePlant inv2 = new InvasivePlant(10, 20);
				InvasivePlant inv3 = new InvasivePlant(10, 30);
	...
	public void addNativePlant(int x, int y) {
		...
		//TODO: override equals and hashcode to make this contains method work
